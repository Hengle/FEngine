...
namespace MobaGame.Collision
{
    ...
    {
        protected SubSimplexClosestResult subsimplexResultsPool = new SubSimplexClosestResult();
        ...
        public void addVertex(VInt3 w, VInt3 p, VInt3 q)
        {
            needsUpdate = true;
        ...
        public int getSimplex(VInt3[] pBuf, VInt3[] qBuf, VInt3[] yBuf)
        {
        ...
        public bool compute_points(out VInt3 p1, out VInt3 p2)
        {
